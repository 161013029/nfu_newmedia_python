...
## 输出：
用户得到输出结果为：历史上的某一天发生的大事件(选取前五件事情)，详见[new_file.py](new_file.py)。在交互界面使用HTML5之[br标签](http://www.runoob.com/tags/tag-br.html)及[body标签](http://www.runoob.com/tags/tag-body.html)
 
## 从输入到输出，本组作品使用了：
### 模块
